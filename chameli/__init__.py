...
class ChameliLogger:
    ...
    def configure(
        ...
        # Log configuration
        self.logger.info("Chameli logging configured", extra={
            "log_file": log_file,
...
def initialize_config(config_file_path: str, force_reload=True):
    ...
    try:
        if is_config_loaded() and not force_reload:
            ...
            chameli_logger.log_info("Configuration initialized successfully", {
                "config_file": config_file_path,
                "force_reload": force_reload
            })
    except Exception as e:
        chameli_logger.log_error("Failed to initialize configuration", e, {
            "config_file": config_file_path,
            "force_reload": force_reload
        })
        raise
